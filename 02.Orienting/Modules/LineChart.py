...
def display_module(modules):
    ...
    def get_image_files():
        ...
        api_url = "https://api.github.com/repos/marianast97/VisualizationLiteracy/contents/02.Orienting/LearningContent/LineChart"
    ...
    base_url = "https://raw.githubusercontent.com/marianast97/VisualizationLiteracy/main/02.Orienting/LearningContent/LineChart/LineChart"
...
"""         # Add the chart for 'Bar Chart Anatomy' subpage
    if current_subpage_index == 0:  # Assuming Bar Chart Anatomy is at index 1
        ...
        data = {
            ...
            "Sales": [150, 180, 220, 210, 240, 230, 250, 260, 280]
        }
        ...
        fig = px.line(
            ...
            x="Year", 
            y="Sales", 
            title="Annual Sales Over Time",
            labels={"Sales": "Sales (in thousand units)", "Year": "Year"}
        )
